...
class SideBar(models.Model):
    ...
    def content_html(self):
        ...
        if self.display_type == self.DISPLAY_HTML:
            ...
            result = render_to_string(template_name='config/blocks/sidebar_posts.html',
                                      context=context)
            ...
            result = render_to_string(template_name='config/blocks/sidebar_comments.html',
                                      context=context)
        return result
